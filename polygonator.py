...
if len(sys.argv) != 5: 
	print( 'Usage: polygonator.py image_file scale spacing plot_obj' )
	sys.exit()

# Get command line arguments
f, SCALE, SPACING, OBJ = sys.argv[1:]
...
# following line	
fig.savefig(os.path.splitext(f)[0]+'_poly.png', dpi=300, facecolor="black")
